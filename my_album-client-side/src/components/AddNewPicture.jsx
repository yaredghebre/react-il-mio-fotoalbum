      ...
      <div className="text-center">
        ...
        >
          <svg
            ...
            height="50px"
            viewBox="0 0 24 24"
            class="fill-none stroke-green-400 duration-300 group-hover:fill-green-800 group-active:fill-green-600 group-active:stroke-green-200 group-active:duration-0"
          >
            <path
