    ...
    <div>
      <div class="flex w-full ">
        <div class="group relative flex max-w-sm flex-col items-center overflow-hidden rounded-xl p-4 text-center shadow-xl transition-all duration-500 hover:shadow-2xl">
          <div class="text-gray-500 transition-all group-hover:scale-105">
            <svg
              class="h-16 w-16"
              stroke="currentColor"
              stroke-width="1.5"
          ...
          <div class="transition-all delay-200 duration-500 group-hover:pb-10">
            <h1 class="font-semibold text-gray-700">Tamani Phiri</h1>
            <p class="text-sm text-gray-500">@senior_developer</p>
          </div>
          <div class="absolute -bottom-full flex w-full items-center justify-evenly gap-2 transition-all delay-200 duration-500 group-hover:bottom-3">
            <div class="flex gap-3 rounded-full bg-gray-700 p-1 text-2xl text-white shadow-sm transition-all delay-200 duration-500 hover:p-2">
              <a class="transition-all delay-200 duration-500 hover:scale-110">
                <svg
                  width="1em"
                  height="1em"
                  fill="currentColor"
