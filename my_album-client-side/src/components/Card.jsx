...
const Card = ({ title, description, image, id, openModal }) => {
  return (
    <div>
      <div className="flex w-full">
        <div className="max-h-lg group relative flex max-w-md flex-col items-center overflow-hidden rounded-xl p-4 text-center shadow-xl transition-all duration-500 hover:shadow-2xl">
